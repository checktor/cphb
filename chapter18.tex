...
Thus, to support both operations, we
should be able to increase all values
in a range and retrieve a single value.
This can be done in $O(\log n)$ time by
using a difference array in combination
with a binary indexed or segment tree
(see Chapter 9.4).
