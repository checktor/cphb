...
There are a total of $\binom{52}{3}$ outcomes,
...
probability distribution. In this matrix, the
$j$th entry of row $i$ contains the probability
of a transition from state $j$ to state $i$.
...
The $k$th \key{order statistic} of an array
