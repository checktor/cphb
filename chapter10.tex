...
Set operations can easily be implemented as bit operations:
...
\[\binom{\texttt{count}}{2} = \dfrac{\texttt{count} \cdot (\texttt{count} - 1)}{2}\]
subgrids with black corners, because we can
choose any two of them to form a subgrid.
